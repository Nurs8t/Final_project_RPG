...
public class WinState extends GameState {
    ...
    private void buildUI() {
        ...
        title.setFontScale(3.8f);
        title.setColor(new Color(0.3f, 1f, 0.45f, 1f));

        Label sub = new Label("The Falcon is saved!", skin, "small");
        sub.setColor(Color.YELLOW);
    ...
    public void render(SpriteBatch batch) {
        ...
        Assets.sr.setColor(new Color(0.02f, 0.16f, 0.04f, 0.72f));
        Assets.sr.rect(340, 150, 600, 420);
        Assets.sr.setColor(new Color(0.2f, 0.95f, 0.35f, 0.5f));
        Assets.sr.rect(340, 150, 3, 420);
        Assets.sr.rect(937, 150, 3, 420);
